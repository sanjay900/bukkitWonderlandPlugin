...
public class WonderlandChunkGen extends ChunkGenerator {
	public int size;
	public int height = 25;
	public Wonderland plugin;
	public WonderlandChunkGen(String worldName, String id, Wonderland plugin) {
		this.plugin = plugin;
		try {
	...
	public byte[][] generateBlockSections(World world, Random random, int chunkX, int chunkZ, BiomeGrid biomeGrid)
	{
		...
		makeFloor(null,result, PlotType.GARDEN.getFloor(), chunkX, chunkZ);
		makeWall(result, chunkX, chunkZ, PlotType.WOOD.getOuterwall(), PlotType.WOOD.getInnerwall(), null);
		return result;
	}
